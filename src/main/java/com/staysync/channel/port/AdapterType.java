...
public enum AdapterType {
     ...
     *
     * <p><b>선언은 구현된 것만 한다</b>(작업지시-17 2절 E). 어댑터가 없던 동안 P3 의
     ...
     * ({@code PUSH_*}) → 예약 피드({@code PULL_BOOKING}, 리비전 피드 + ack). {@code WEBHOOK_BOOKING} 은
     * 안 만든다(5절 4번). {@code SNAPSHOT_BOOKING} 도 아니다 — 취소는 리비전 상태로 온다.
     */
